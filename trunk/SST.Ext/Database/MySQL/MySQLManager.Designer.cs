namespace SST.Ext.Database.MySQL
{
    partial class MySQLManager
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "提示:最保险的备份数据库的方式是找到MySQL下面的data文件夹，备份此文件夹即可！里面的文件夹名称都是数据库的名称！";
            // 
            // MySQLManager
            // 
            ...
            this.Name = "MySQLManager";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "MySQL 管理";
            this.Shown += new System.EventHandler(this.MySQLManager_Shown);
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.MySQLManager_FormClosing);
